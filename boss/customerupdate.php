                                        ...
                                        <div class="p-2">
                                            <form class="form-horizontal" role="form" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" required name="txtCustomer" title="Enter only Alphabet and digit between 3 to 50 character long" class="form-control" value="<?php echo $row['shipper_name'];?>" placeholder="Customer Name">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txtCity" title="Enter only Alphabet" class="form-control" required value="<?php echo $row['shipper_city'];?>" placeholder="City">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2  col-form-label" for="txtPhone">Phone</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txtPhone" title="Enter only Digit between 0 to 9 and 10 character" value="<?php echo $row['shipper_phone1'];?>" class="form-control" placeholder="Phone">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2  col-form-label" for="txtMob">Mobile</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txtMob" title="Enter only Digit between 0 to 9 and 10 character" class="form-control" value="<?php echo $row['shipper_mobile'];?>" placeholder="Mobile No.">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
