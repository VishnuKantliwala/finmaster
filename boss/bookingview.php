        ...
        <div class="content-page">
            ...
            <script>
                    ...
                    Swal.fire({
                        ...
                        if (t.value) {
                            $.ajax({
                                ...
                                data: 'invoice_id=' + id + '&task=Invoice',
                ...
                function getRecords(from_date,end_date)
                {
                    counter++;
                    $.ajax({  
                        url:"getAllTypeRecords.php?type=getInvoiceRecords",  
                        method:"POST",  
                        ...
                        success:function(data){  
                            ...
                            if(data != "false")
                            {
                                ...
                                for(i=0;i<length;i++)
                                {
                                    ...
                                    "<td ><a href='invoiceOriginal.php?invoice_id="+data[i].invoice_id+"' target='_BLANK'><div style='border:1px solid #dee2e6;text-align:center;padding:5px;'>Print <i class='dripicons-print'></i></div></a></td>"+
                                    "<td ><a onClick='deleteRecord("+data[i].invoice_id+")'><div style='border:1px solid #dee2e6;text-align:center;padding:5px;'>Delete <i class='mdi mdi-delete'></i></div></a></td>"+
                                    "</tr>";
                                }
                                row += "</tbody>";
