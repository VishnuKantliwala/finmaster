                                      ...
                                      <tbody>
                                          ...
                                          ?>
                                                  <tr>
                                                      ...
                                                      <td><a href="taskupdate.php?task_id=<?php echo $row['task_id']; ?>"><i class="mdi mdi-border-color"></i></a></td>
                                                      <td><a onClick="deleteRecord(<?php echo $row['task_id']; ?>)"><i class="mdi mdi-delete"></i></a></td>
                                                  </tr>
                                          <?php
                                              }
                                          }
                                ...
                                success: function(data) {
                                    if (data == 'true') {
                                        Swal.fire({
                                          ...
                                          window.open('taskview.php', '_self');
                                        });
                                    } else {
                                        Swal.fire({
