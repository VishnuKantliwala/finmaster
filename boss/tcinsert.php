...
if (isset($_POST['Submit'])) {
    $name = $_POST['txtDesc'];
    $sql = "INSERT INTO tbl_tc(tc_desc) VALUES('" . $name . "')";
    //echo $sql;
    $cn->insertdb($sql);
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title">Add Term & Condition</h4>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="p-2">
                                            <form class="form-horizontal" role="form" method="post">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea type="text" required name="txtDesc" class="form-control" placeholder="Description"></textarea>
                                                        <script>
