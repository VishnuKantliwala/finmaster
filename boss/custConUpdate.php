...
$si_id = $_GET['si_id'];
$sql = "SELECT * FROM tbl_shipper_info WHERE si_id='$si_id'";
...
if (isset($_POST['Submit'])) {
  ...
  $sql = "UPDATE tbl_shipper_info SET person_name='" . $person . "', mobile_no='".$mobile."', email_id='".$email."' WHERE si_id='" . $si_id . "'";
  //echo $sql;
  $cn->insertdb($sql);
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title">Update Customer Contact</h4>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="p-2">
                                            <form class="form-horizontal" role="form" method="post">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txtPerson" class="form-control" placeholder="Person Name" value="<?php echo $row['person_name']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2  col-form-label" for="txtMobile">Mobile No</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txtMobile" class="form-control" placeholder="Mobile No" value="<?php echo $row['mobile_no']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2  col-form-label" for="txtEmail">Email-ID</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txtEmail" class="form-control" placeholder="Email-ID" value="<?php echo $row['email_id']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
