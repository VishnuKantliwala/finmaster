...
$service_confirmation_no = $_GET['service_confirmation_no'];
?>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                <?
                                $sqlCustomer = $cn->selectdb("SELECT c.*,sc.currency,sc.attendant_id,sc.confirmation_date FROM tbl_shipper c,tbl_service_confirmation sc  where sc.shipper_id = c.shipper_id AND sc.service_confirmation_id =".$service_confirmation_no);
                                if(mysqli_num_rows($sqlCustomer) > 0)
                                {
                                    $rowCustomer = mysqli_fetch_assoc($sqlCustomer);
                                ?>
                                            ...
                                            <div class="p-2">
                                                <div class="form-group row">
                                                    <div class="col-sm-8">
                                                        ...
                                                        <input type="text" name="txtServiceConfirmationNo" id="txtServiceConfirmationNo" readonly class="form-control-plaintext" value="<? echo $service_confirmation_no; ?>">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label" for="txtDate">Date</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="booking_date" value="<?php echo date("m/d/Y",strtotime($rowCustomer["confirmation_date"])); ?>" placeholder="mm/dd/yyyy" id="datepicker">
                                            ...
                                            <div class="p-1">
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" id="customer_name" required title="Enter only Alphabate" name="customer_name" class="form-control" placeholder="Name" value="<? echo $rowCustomer["shipper_name"] ?>">
                                                        
                                                        <input type="hidden" id="customer_id" name="customer_id" class="form-control" value="<? echo $rowCustomer["shipper_id"] ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="txtAttendant" id="txtAttendant" class="form-control">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $row['attendant_id']; ?>" <? if($rowCustomer["attendant_id"] == $row['attendant_id']) echo "Selected"; ?>><?php echo $row['attendant_name']; ?></option>
                                                            <?php
                                                                }
                                                            }
                                                            ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <textarea id="customer_address" name="customer_address" class="form-control" placeholder="Address"><? echo $rowCustomer["shipper_address"] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        <label class="col-form-label" for="customer_pincode">Pincode</label>
                                                        <input type="text" id="customer_pincode" name="customer_pincode" pattern="[0-9]{6}" title="Enter only Digit between 0 to 9 and 6 character" class="form-control" placeholder="Pincode" value="<? echo $rowCustomer["shipper_pincode"] ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="col-form-label" for="customer_city">City</label>
                                                        <input type="text" id="customer_city" name="customer_city"  title="Enter only Alphabet" class="form-control" placeholder="City" value="<? echo $rowCustomer["shipper_city"] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label" for="customer_phone1">Phone No.</label>
                                                        <input type="text" id="customer_phone1" name="customer_phone1" title="Enter only Digit between 0 to 9 and 10 character" class="form-control" placeholder="Phone No." value="<? echo $rowCustomer["shipper_phone1"] ?>">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label" for="customer_phone2">Mobile</label>
                                                        <input type="text" id="customer_phone2" name="customer_phone2" pattern="[0-9]{10}" title="Enter only Digit between 0 to 9 and 10 character" class="form-control" placeholder="Mobile" value="<? echo $rowCustomer["shipper_mobile"] ?>">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label class="col-form-label" for="customer_email">Email-ID</label>
                                                        <input type="email" id="customer_email" name="customer_email" class="form-control" placeholder="Email-ID" value="<? echo $rowCustomer["shipper_email"] ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="gst_type" id="gst_type" class="form-control">
                                                            <option value="NOGST" <? if($rowCustomer["gst_type"] == "NOGST") echo "Selected"; ?>>NOGST</option>
                                                            <option value="CGST/SGST" <? if($rowCustomer["gst_type"] == "CGST/SGST") echo "Selected"; ?>>CGST/SGST</option>
                                                            <option value="IGST" <? if($rowCustomer["gst_type"] == "IGST") echo "Selected"; ?>>IGST</option>
                                                            <option value="UTGST" <? if($rowCustomer["gst_type"] == "UTGST") echo "Selected"; ?>>UTGST</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="col-form-label" for="gst_no">GST No.</label>
                                                        <input type="text" id="gst_no" name="gst_no" class="form-control" placeholder="GST No." value="<? echo $rowCustomer["gst_no"] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select name="payment_type" id="payment_type" class="form-control">
                                                            ...
                                                            <option value="cash" <? if($rowCustomer["type"] == "cash") echo "Selected"; ?>>CASH</option>
                                                            <option value="cheque" <? if($rowCustomer["type"] == "cheque") echo "Selected"; ?>>CHEQUE</option>
                                                            <option value="credit" <? if($rowCustomer["type"] == "credit") echo "Selected"; ?>>CREDIT</option>
                                                            <option value="topay" <? if($rowCustomer["type"] == "topay") echo "Selected"; ?>>TO-PAY</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="col-form-label" for="gst_no">Currency</label>
                                                        <input type="text" id="currency" name="currency" class="form-control" placeholder="Currency" value="<? echo $rowCustomer["currency"] ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                &nbsp;
...
function addLoader()
{
	...
	<script>  
		...
		$('#customerForm').on('submit',function(event){  
			...
			setTimeout(() => {
				$.ajax({  
					url:"service_insert_rate.php?type=updateCustomerDetails",  
					method:"POST",  
