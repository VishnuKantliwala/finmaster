...
$sql = "SELECT S.*,P.name FROM tbl_proservicelist AS S, tbl_product AS P WHERE S.product_id=P.product_id AND S.proforma_id='".$rowB['proforma_id']."'";
//echo $sql;
...
if (isset($_POST['btnSubmit'])) {
    ...
    if($_POST['txtNet']!="0"){
        ...
        $sql = "UPDATE `tbl_proforma` SET `booking_date`='".$booking_date."',`shipper_code`='".$lastShipper_id."',`rate`='".$actual_price."', `charge`='".$charges."', `total_amount`='".$total_amount."', `gst_charge`='".$gst_charge."', `net_amount`='".$net_amount."', `received`='".$received."', `credit`='".$credit."', `website_link`='".$link."', `entrypersonname`='".$_SESSION['user']."', `attendant_id`=".$attendant." WHERE proforma_id='".$proforma_id."'";
        $cn->insertdb($sql);
        $sql="DELETE FROM tbl_proservicelist WHERE proforma_id='".$proforma_id."'";
        $cn->insertdb($sql);
        //$last_id = mysqli_insert_id($con->getConnection());
        if (mysqli_affected_rows($cn->getConnection()) > 0) {
            foreach ($product_ids as $keys => $value) {
                $sql="INSERT INTO tbl_proservicelist(proforma_id,product_id,duration,yorm,qty,rate,price,remarks) VALUES('".$proforma_id."','".$product_ids[$keys]."','".$durations[$keys]."','".$dnames[$keys]."','".$qtys[$keys]."','".$rates[$keys]."','".$totals[$keys]."','".$remarks[$keys]."')";
               // echo $sql;
                $cn->insertdb($sql);
            }
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Update Proforma & Quotation</h4>
                </li>
        ...
        <div class="content-page">
                ...
                <form class="form-horizontal" autocomplete="off" role="form" method="post" enctype="multipart/form-data">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Proforma Invoice Info</h4>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="p-2">
                                                <div class="form-group row">
                                                    <div class="col-sm-8">
                                                        <label class="col-form-label" for="txtBook">Proforma No.</label>
                                                        <input type="text" name="txtProforma" id="txtProforma" value="<?php echo $rowB['proforma_id'];?>" readonly class="form-control-plaintext">
                                                    </div>
                                                    <div class="col-sm-4">
                                            ...
                                            <div class="p-1">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" required pattern="[A-Z a-z]{3,50}" title="Enter only Alphabate between 0 to 50 character" value="<?php echo $rowS['shipper_name'];?>" id="txtShipper" name="txtShipper" class="form-control" placeholder="Name">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" id="txtPincode" name="txtPincode" pattern="[0-9]{6}" title="Enter only Digit between 0 to 9 and 6 character" value="<?php echo $rowS['shipper_pincode'];?>" class="form-control" placeholder="Pincode">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="col-form-label" for="txtCity">City</label>
                                                        <input type="text" id="txtCity" name="txtCity" pattern="[A-z a-z]{10}" title="Enter only Alphabet" class="form-control" value="<?php echo $rowS['shipper_city'];?>" placeholder="City">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" id="txtMobile" reuired name="txtMobile" pattern="[0-9]{10}" title="Enter only Digit between 0 to 9 and 10 character" class="form-control" value="<?php echo $rowS['shipper_mobile'];?>" placeholder="Mobile">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" value="<?php echo $rowS['gst_no'];?>" id="txtGST" name="txtGST" class="form-control" placeholder="GST No.">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                            ...
                            <div class="col-md-4">
                                <div class="p-1">
                                    <div class="form-group row" style="margin-bottom: 0.5rem;">
                                        <label class="col-md-6  col-form-label" for="txtTotal">Total</label>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="proformainvoiceOriginal.php?proforma_id=<?php echo $_GET['proforma_id'];?>" class="btn btn-icon waves-effect waves-light btn-success" target="_blank"> <i class="dripicons-print" style="color:#fff;"></i> </a>
                                                    <a href="proformacopy.php?proforma_id=<?php echo $_GET['proforma_id'];?>" class="btn btn-icon btn-primary"><i class="far fa-copy" style="color:#fff;"></i></a>
                                                    <a href="proformaview.php" class="btn btn-lighten-primary waves-effect waves-primary">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <script>
                ...
                if (isset($success)) {
                    echo "toastr.success('" . $success . "');setTimeout(()=>{window.open('proformaview.php','_self');},2000);";
                }
                ?>
            </script>
