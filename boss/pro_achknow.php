...
if (isset($_POST['Submit'])) {
    ...
    $sql="INSERT INTO tbl_project_achknow(shipper_id,uname,description,work_date,work_stime,work_etime) VALUES('".$project."','".$_SESSION['user']."','".$desc."','".$date."','".$stime."','".$etime."')";
    //echo $sql;
    $cn->insertdb($sql);
                                              ...
                                              <form class="form-horizontal" role="form" method="post">
                                                  ...
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $row1['shipper_id'];?>"><?php echo $row1['shipper_name'];?></option>
                                                        <?php
                                                            }
                                                        ?>
                                                        </select>
                                                  ...
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                          <textarea type="text" name="txtDesc" class="form-control" placeholder="Description"></textarea>
                                                          <script>
                                                  ...
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                          <div class="input-group">
                                                                <input type="text" class="form-control" name="txtDate" placeholder="mm/dd/yyyy" id="datepicker">
                                                  ...
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                          <div class="input-group">
                                                            <input id="timepicker2" name ="txtSTime" type="text" class="form-control">
                                                            <div class="input-group-append">
                                                  ...
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                          <div class="input-group">
                                                            <input id="timepicker22" name="txtETime" type="text" class="form-control">
                                                            <div class="input-group-append">
                                                                <span class="input-group-text"><i class="mdi mdi-clock-outline"></i></span>
                                                            </div>
                                                          </div>
