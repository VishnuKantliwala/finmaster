    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Proforma Invoice</h4>
                </li>
            </ul>
        </div>
        <!-- end Topbar -->
        ...
        <div class="content-page">
            ...
            <script>
                    ...
                    Swal.fire({
                        ...
                        if (t.value) {
                            $.ajax({
                                ...
                                data: 'proforma_id=' + id +'&task=Proforma',
                ...
                function getRecords(from_date,end_date)
                {
                    counter++;
                    $.ajax({  
                        url:"getAllTypeRecords.php?type=getProformaInvoiceRecords",  
                        method:"POST",  
                        ...
                        success:function(data){  
                            ...
                            if(data != "false")
                            {
                                ...
                                for(i=0;i<length;i++)
                                {
                                    ...
                                    "<td >"+data[i].proforma_id+"</td>"+
                                    "<td >"+data[i].entry_date+"</td>"+
                                    "<td >"+data[i].total_amount+"</td>"+
                                    "<td >"+data[i].user_name+"</td>"+
                                    "<td ><a href='invoiceProforma.php?proforma_id="+data[i].proforma_id+"' target='_BLANK'><div style='border:1px solid #dee2e6;text-align:center;padding:5px;'>Print <i class='dripicons-print'></i></div></a></td>"+
                                    "<td ><a onClick='deleteRecord("+data[i].proforma_id+")'><div style='border:1px solid #dee2e6;text-align:center;padding:5px;'>Delete <i class='mdi mdi-delete'></i></div></a></td>"+
                                    "</tr>";
                                }
                                row += "</tbody>";
