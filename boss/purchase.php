...
if (isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO `tbl_purchase`(`entry_person_id`, `expense_id`, `isGST`, `amount`,`gst_rate`, `receipt_img`,`description`, `entry_date_time`) VALUES (".$_SESSION['user_id'].",".$expense_id.",".$_POST['isgst'].",'" . $amount . "','".$_POST['gstrate']."','".$file_name."','".$_POST['description']."','".$dateTime."')";
    //echo $sql;
    $cn->insertdb($sql);
                                            ...
                                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <select id="expense_id" name="expense_id" class="form-control">
                                                        ...
                                                        if(mysqli_fetch_assoc($sql) > 0)
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                    <option value="<? echo $row['expense_id'] ?>"><? echo $row['expense_name'] ?></option>
                                                                <?
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <textarea name="description" placeholder="Add Description Here" class="form-control" style="height:175px;"></textarea>
                                                    </div><!-- end col -->
                                                    <div class="col-sm-6">
                                                        <div class="card-box">
                                                            <h4 class="header-title mt-0 mb-3">Bill Reciept (Optional)</h4>
