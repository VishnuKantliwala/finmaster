...
if (isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO tbl_expense(expense_name,expense_gst) VALUES('" . $name . "','".$gst."')";
    //echo $sql;
    $cn->insertdb($sql);
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title">Add Expense</h4>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="p-2">
                                            <form class="form-horizontal" role="form" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" required name="txtGST" class="form-control" placeholder="GST">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
