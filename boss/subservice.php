...
if (isset($_POST['Submit'])) {
    ...
    if($service_id != 0)
    {
        $sql = "INSERT INTO tbl_sub_product(`product_id`,`sub_product_name`,`description`) VALUES(" . $service_id . ",'".$name."','".$desc."')";
        //echo $sql;
        $cn->insertdb($sql);
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        if($cn->numRows($sqlService) > 0)
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option value="<? echo $rowService['product_id'] ?>"><? echo $rowService['name'] ?></option>
                                                                <?
                                                            }
                                                        }
                                                        else
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" required name="txtName" class="form-control" placeholder="Sub Service Name">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2  col-form-label" for="txtDesc">Description</label>
                                                    <div class="col-sm-10">
                                                        <textarea required name="txtDesc" class="form-control" placeholder="Description">
                                                        </textarea>
                                                        <script>
