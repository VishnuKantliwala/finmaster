...
if (isset($_POST['btnSubmit'])) {
    ...
    if($_POST['txtNet']!="0"){
        ...
        $sql = "INSERT INTO `tbl_proforma`(`booking_date`,`shipper_code`,`rate`, `charge`, `total_amount`, `gst_charge`, `net_amount`, `received`, `credit`, `website_link`, `entrypersonname`, `attendant_id`) VALUES ('".$booking_date."','".$lastShipper_id."','".$actual_price."','".$charges."','".$total_amount."','".$gst_charge."','".$net_amount."','".$received."', '".$credit."','".$link."','".$_SESSION['user']."',".$attendant.")";
        $cn->insertdb($sql);
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main"> Proforma & Quotation</h4>
                </li>
        ...
        <div class="content-page">
                                        ...
                                        <div class="col-12">
                                            <div class="p-2">
                                                <div class="form-group row">
                                                    <div class="col-sm-8">
                                                        <label class="col-form-label" for="txtProforma">Proforma No.</label>
                                                        <input type="text" name="txtProforma" id="txtProforma" readonly class="form-control-plaintext">
                                                    </div>
                                                    <div class="col-sm-4">
                                            ...
                                            <div class="p-1">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" id="txtShipper" required pattern="[A-Z a-z]{3,50}" title="Enter only Alphabate between 0 to 50 character" name="txtShipper" class="form-control" placeholder="Name">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" id="txtMobile" require name="txtMobile" pattern="[0-9]{10}" title="Enter only Digit between 0 to 9 and 10 character" class="form-control" placeholder="Mobile">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <label class="col-form-label" for="txtEmail">Email-ID</label>
                                                        <input type="text" id="txtEmail" required name="txtEmail" class="form-control" placeholder="Email-ID">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" id="txtGST" name="txtGST" class="form-control" placeholder="GST No.">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <a href="proformaview.php" class="btn btn-lighten-primary waves-effect waves-primary  width-sm">Cancel</a>
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    //Fetch Inward_ID
                    $.ajax({
                        url: "fetch_proformaID.php",
                        success: function(data) {
                            $("#txtProforma").val(data);
                        }
                    });
