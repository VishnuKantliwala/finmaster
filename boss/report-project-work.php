...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            <div class="content">
                <!-- Start Content-->
                <form class="form-horizontal" action="lbl_print_project_work.php" autocomplete="off" role="form" method="post" enctype="multipart/form-data">
                                          ...
                                          <div class="p-2">
                                                  <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                        ...
                                                        <br> All Projects
                                                        <input type="checkbox" name="chkProject" checked="" id="chkProject"/>
                                                      </div>
                                                  </div>
                                                  <div class="form-group row">
