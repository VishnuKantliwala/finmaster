                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                      ...
                                      <tbody>
                                          <?php
                                          $sql = "SELECT u.user_id,u.user_name,u.user_password,u.user_email,u.user_designation,u.user_last_login_date_time,r.role_name FROM tbl_user u,tbl_role r WHERE u.role_id = r.role_id";
