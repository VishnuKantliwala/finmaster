...
?>
      ...
      <section class="section-30 section-md-40 section-lg-66 section-xl-bottom-90 bg-gray-dark page-title-wrap novi-background custom-bg-image" style="background-image: url(page/big_img/<? echo $image; ?>);">
        ...
        <div class="container">
		  ...
		  <?
		  $sql = $cn->selectdb("SELECT * FROM  `tbl_category` where cat_parent_id=0  order by recordListingID ASC" );
		  ...
		  ?>
            <li class="col-md-6">
              <div class="block-service bg-black bg-image custom-bg-image" style="background-image: url(category/big_img/<? echo $cat_image; ?>);">
                <div class="block-inner">
                  <div class="block-header">
                    <a href="Services/<? echo $slug; ?>/"><h4><? echo $cat_name; ?></h4></a>
                  </div>
